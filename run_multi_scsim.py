...
def parse_args():
    ...
    parser.add_argument('--doubletfrac', type=float,
                        ...
                        default=0.)
    a = parser.parse_args()
    return(a.outdir, a.seed, a.numsims, a.firstseed, a.lastseed, a.deloc, a.K, a.nproggoups, a.ncells, a.doubletfrac)
...
def main():
    (outdir, randseed, numsims, firstseed, lastseed, deval, K, nproggroups, ncells, doubletfrac) = parse_args()
    ngenes=10000
    nproggenes = 400
